                ...
                <div class="col-md-6 col-lg-5">
                    <div class="register-box bg-white box-shadow border-radius-10">
                        <div class="wizard-content">
                            <form class="tab-wizard2 wizard-circle wizard" action="/Admin/Users/save" method="post">
                                <?= csrf_field(); ?>
                                    ...
                                    <div class="form-wrap max-width-600 mx-auto">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="password"
                                                    class="form-control <?= ($valid->hasError('password')) ? 'is-invalid' : ''; ?>"
                                                    id="password2" name="password2" value="<?= old('password2'); ?>">
                                                <div class="invalid-feedback">
                                                    <?= $valid->getError('password'); ?>
                                                </div>
                                        ...
                                        <ul class="register-info">
                                            <li>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8" id="emailcek">lala@Gmail.com</div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="row">
                                                    <div class="col-sm-4 weight-600">Username</div>
                                                    <div class="col-sm-8" id="usercek">Example</div>
                                                </div>
                                            </li>
